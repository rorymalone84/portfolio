<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-width-md mx-auto sm:px-6 lg:px-8 bg-gray-200 shadow-md rounded-md">
            <form method="POST" class="p-4" action="{{ route('about.update', $about->id) }}"
                ...
                <div
                    ...
                    <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                        <label for="editor" class="sr-only">Update description</label>
                        <textarea id="editor" rows="8" name="description"
                            class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400"
                            placeholder="Write an article..." required>{{ $about->description }}</textarea>
                    </div>
