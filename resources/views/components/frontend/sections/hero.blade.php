    ...
    <div class="relative isolate px-6 pt-14 lg:px-8">
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div class="text-center">
                ...
                <p class="mt-6 text-lg leading-8 text-gray-800">You have reached the web development portfolio of Rory
                    Malone.</p>
                <div class="mt-10 flex items-center justify-center gap-x-6">
                    ...
                    <a href="mailto:rorymalone@live.com" class="text-sm font-semibold leading-6 text-gray-900">E-mail me
