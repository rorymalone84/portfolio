        ...
        <div
            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl lg:mx-0">
                    ...
                    <p class="mt-2 mb-4 text-lg leading-8 text-gray-800 py-2">Leave a message below for any enquiries.
                    </p>
                </div>
            </div>
            ...
            <form x-data="{
                ...
                <div class="px-8 lg:px-8p-4 sm:w-full md:w-1/2 rounded">
                    ...
                    <div x-text="formMessage" x-show="formShow"
                        x-if="formShow, setTimeout(() => formShow = false, 10000)"
